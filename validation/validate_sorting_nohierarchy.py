...
if __name__ == "__main__":
    ...
    # Path to load policy
    default_load_path = "../models/list_npi_nohierarchy_2019_5_21-15_28_47-3_max_4_val_4.pth"
    ...
    max = int(default_load_path.split("max")[1].split('_')[1])
    val = int(default_load_path.split("val")[1].split('_')[1][:-len('.pth')])
    ...
    for len in [3, 4, 5, 6, 7, 8, 9, 10]:
        ...
        for _ in range(100):
            ...
            env = ListEnv(length=len, encoding_dim=conf.encoding_dim, hierarchy=False)
